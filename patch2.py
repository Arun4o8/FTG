...
if content.find(submit_block_start) != -1 and content.find(score_line) != -1:
    ...
    submit_replacement_done = True

# remove finalQ3Ans line that breaks
final_q3_block_start = "const finalQ3Ans = document.getElementById('q3Answer').value.trim();"
final_q3_block_end = "const totalScore ="
if content.find(final_q3_block_start) != -1:
    content = content[:content.find(final_q3_block_start)] + content[content.find(final_q3_block_end):]

with open(file_path, "w") as f:
    f.write(content)

print("Patch applied successfully.")
print("HTML DB:", html_end_full != -1 and content.find(html_start) != -1)
print("JS DB:", js_replacement_done)
print("Submit DB:", submit_replacement_done)
